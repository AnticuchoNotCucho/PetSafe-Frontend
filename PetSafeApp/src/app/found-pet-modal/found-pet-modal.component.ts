...
@Component({
  ...
  templateUrl: './found-pet-modal.component.html',
  styleUrl: './found-pet-modal.component.css'
})
export class FoundPetModalComponent {
  ...
  constructor(private reportsService: ReportsService,
              public dialogRef: MatDialogRef<FoundPetModalComponent>,
  ...
  submit(): void {
    ...
    if (userDetailsString) {
      ...
      const petReportDTO: PetReportDTO = {
        ...
        typeId: 2, // ID del tipo de mascota
